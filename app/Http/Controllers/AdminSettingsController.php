...
class AdminSettingsController extends Controller
{
    ...
    public function generalSettings()
    {
        $settings = [
            ...
            'global_registration_status' => AppSetting::get('global_registration_status', 'open'),
            'registration_status' => AppSetting::get('registration_status', 'open'),
            'registration_start_date' => AppSetting::get('registration_start_date', '2026-09-01T08:00'),
            'registration_deadline' => AppSetting::get('registration_deadline', '2026-09-25T23:59'),
    ...
    public function updateGeneralSettings(Request $request)
    {
        $data = $request->validate([
            ...
            'global_registration_status' => 'nullable|string|in:open,closed,auto',
            'registration_status' => 'nullable|in:open,closed,technical_meeting,ongoing,finished',
            'registration_start_date' => 'nullable|string|max:50',
            'registration_deadline' => 'nullable|string|max:50',
            'registration_auto_close' => 'nullable|string|max:5',
