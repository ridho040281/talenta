            ...
            <div class="space-y-3">
                ...
                <div class="border border-slate-300 rounded-xl overflow-hidden text-xs">
                    ...
                    <div class="p-3 grid grid-cols-1 sm:grid-cols-3 gap-2.5 items-center">
                        ...
                        <div class="col-span-1 sm:col-span-3 pt-2 mt-1 border-t border-slate-100 flex items-center gap-2">
                            <span class="text-slate-400 text-[10px] uppercase font-bold shrink-0">Judul Lagu Pilihan:</span>
                            <span class="font-bold text-purple-900 text-xs bg-purple-50 px-2.5 py-0.5 rounded-md border border-purple-100">🎵 {{ $registration->chosen_song }}</span>
                        </div>
                        @endif
                    </div>
