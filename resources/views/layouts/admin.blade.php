...
<body class="text-slate-100 font-sans antialiased min-h-screen flex selection:bg-[#7A5AF8] selection:text-white relative overflow-x-hidden" 
    ...
    <aside :class="sidebarOpen ? 'w-72 max-w-[85vw] sm:w-64 translate-x-0' : '-translate-x-full lg:translate-x-0 lg:w-20'" 
        ...
        <div class="h-16 flex items-center border-b border-white/[0.08] transition-all duration-300"
            ...
            <a href="{{ auth()->check() && auth()->user()->role === 'peserta' ? route('peserta.dashboard') : (auth()->check() && in_array(auth()->user()->role, ['superadmin', 'panitia']) ? route('admin.dashboard') : route('home')) }}" 
               class="flex items-center gap-2.5 overflow-hidden group min-w-0"
               :class="sidebarOpen ? '' : 'justify-center'">
                ...
                @endif
                <div x-show="sidebarOpen" x-transition.opacity.duration.200ms class="overflow-hidden min-w-0">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-4 text-xs font-medium scrollbar-thin scrollbar-thumb-slate-800">
            ...
            @if(in_array(auth()->user()->role, ['superadmin', 'panitia']))
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.users') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('admin.users*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.participants.multi') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('admin.participants.multi*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'justify-between px-3 py-2.5' : 'justify-center px-0 py-2.5'">
                        <div class="flex items-center gap-3 truncate">
                            <i data-lucide="layers" class="w-4 h-4 shrink-0 {{ request()->routeIs('admin.participants.multi*') ? 'text-white' : 'text-amber-400' }}"></i>
                            <span x-show="sidebarOpen" x-transition.opacity.duration.200ms class="truncate">Peserta Multi Lomba</span>
                        </div>
                    ...
                    <a href="{{ route('admin.juri.wasit') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('admin.juri.wasit*') || request()->routeIs('admin.undian*') || request()->routeIs('juri.*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.berita-acara.index') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('admin.berita-acara*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.settings.whatsapp.blast') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('admin.settings.whatsapp*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                    ...
                    <a href="{{ route('admin.settings.popup.index') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('admin.settings.popup*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                    ...
                    <a href="{{ route('admin.settings.app.info') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('admin.settings.app.info*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
            ...
            @if(auth()->user()->role === 'pic_lomba')
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('pic.undian') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('pic.undian*') || request()->routeIs('pic.hacker.draw*') || request()->routeIs('pic.spin.wheel*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                ...
                <div class="space-y-1 pt-1">
                    ...
                    <a href="{{ route('badminton.index') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('badminton.index*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                    ...
                    <a href="{{ route('badminton.arena') }}" target="_blank" 
                       class="relative group flex items-center rounded-2xl transition hover:bg-white/[0.04] text-slate-400 hover:text-slate-200"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                ...
                <div class="space-y-1 pt-1">
                    ...
                    <a href="{{ route('pic.berita-acara.index') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('pic.berita-acara*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                ...
                <div class="space-y-1">
                    ...
                    @if($judgedComps->isNotEmpty())
                        ...
                        @foreach($judgedComps as $jComp)
                            ...
                            @if($isBltComp)
                                <a href="{{ route('badminton.index') }}" 
                                   class="relative group flex items-center rounded-xl transition text-xs {{ request()->routeIs('badminton.*') ? 'bg-gradient-to-r from-emerald-500/20 to-teal-500/20 text-emerald-300 font-bold border border-emerald-500/30' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                                   :class="sidebarOpen ? 'justify-between px-3 py-2' : 'justify-center px-0 py-2'">
                            ...
                            @elseif($isSportComp)
                                <a href="{{ route('juri.scoring', $jComp->id) }}" 
                                   class="relative group flex items-center rounded-xl transition text-xs {{ request()->routeIs('juri.scoring') && request()->route('competition_id') == $jComp->id ? 'bg-amber-500/20 text-amber-300 font-bold border border-amber-500/30' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                                   :class="sidebarOpen ? 'justify-between px-3 py-2' : 'justify-center px-0 py-2'">
                                    <div class="flex items-center gap-2 truncate">
                            ...
                            @else
                                <a href="{{ route('juri.scoring', $jComp->id) }}" 
                                   class="relative group flex items-center rounded-xl transition text-xs {{ request()->routeIs('juri.scoring') && request()->route('competition_id') == $jComp->id ? 'bg-[#7A5AF8]/20 text-[#A594FD] font-bold border border-[#7A5AF8]/30' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                                   :class="sidebarOpen ? 'justify-between px-3 py-2' : 'justify-center px-0 py-2'">
                                    <div class="flex items-center gap-2 truncate">
            ...
            @if(auth()->user()->role === 'peserta')
                <div class="space-y-1">
                    ...
                    <a href="{{ route('peserta.registrations') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('peserta.registrations*') || request()->routeIs('peserta.registration.detail*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
                    ...
                    <a href="{{ route('peserta.collective.wizard') }}" 
                       class="relative group flex items-center rounded-2xl transition {{ request()->routeIs('peserta.collective*') || request()->routeIs('peserta.invoices*') ? 'bg-gradient-to-r from-[#7A5AF8] to-[#4E6EFF] text-white font-bold shadow-lg shadow-[#7A5AF8]/25' : 'hover:bg-white/[0.04] text-slate-400 hover:text-slate-200' }}"
                       :class="sidebarOpen ? 'gap-3 px-3 py-2.5 justify-start' : 'px-0 py-2.5 justify-center'">
        ...
        <div class="p-3 border-t border-white/[0.08] bg-[#080C15]/80">
            <!-- Full mode footer -->
            <div x-show="sidebarOpen" class="flex items-center justify-between gap-2">
