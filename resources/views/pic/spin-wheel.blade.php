            ...
            <div class="flex-1 overflow-y-auto space-y-3.5 pr-1 max-h-[420px]">
                ...
                <div class="p-4 rounded-2xl bg-slate-950/70 border-2 transition"
                    ...
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center gap-2">
                            <span class="px-2.5 py-0.5 rounded-lg text-xs font-black uppercase tracking-wider bg-amber-500 text-slate-950 flex items-center gap-1 shadow-sm">
                                <span>⭐ SEED 1</span>
                                <span class="opacity-80">• Slot #1</span>
                            </span>
                            <span class="text-[11px] text-amber-400 font-bold">Puncak Bagan Atas</span>
                        </div>
                        <button type="button" x-show="selectedSeed1" @click="setSeed(1, '')" class="text-[10px] text-rose-400 hover:text-rose-300 font-bold cursor-pointer">
                            Kosongkan Seed 1
                        </button>
                    </div>
                    <label class="block text-[11px] text-slate-400 mb-1.5 font-medium">Pilih Peserta untuk Seed 1:</label>
                ...
                <div class="p-4 rounded-2xl bg-slate-950/70 border-2 transition"
                    ...
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center gap-2">
                            <span class="px-2.5 py-0.5 rounded-lg text-xs font-black uppercase tracking-wider bg-amber-500/20 text-amber-300 border border-amber-500/40 flex items-center gap-1 shadow-sm">
                                <span>⭐ SEED 2</span>
                                <span class="opacity-80" x-text="'• Slot #' + activeParticipants.length"></span>
                            </span>
                            <span class="text-[11px] text-amber-400 font-bold">Dasar Bagan Bawah</span>
                        </div>
                        <button type="button" x-show="selectedSeed2" @click="setSeed(2, '')" class="text-[10px] text-rose-400 hover:text-rose-300 font-bold cursor-pointer">
                            Kosongkan Seed 2
                        </button>
                    </div>
                    <label class="block text-[11px] text-slate-400 mb-1.5 font-medium">Pilih Peserta untuk Seed 2:</label>
                ...
                <div x-show="activeParticipants.length >= 3" class="p-4 rounded-2xl bg-slate-950/70 border-2 transition"
                    ...
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center gap-2">
                            <span class="px-2.5 py-0.5 rounded-lg text-xs font-black uppercase tracking-wider bg-slate-800 text-slate-300 border border-slate-700 flex items-center gap-1 shadow-sm">
                                <span>⭐ SEED 3</span>
                                <span class="opacity-80" x-text="'• Slot #' + calculateSlotPreview(3)"></span>
                            </span>
                            <span class="text-[11px] text-slate-400 font-bold">Bagan Bawah</span>
                        </div>
                        <button type="button" x-show="selectedSeed3" @click="setSeed(3, '')" class="text-[10px] text-rose-400 hover:text-rose-300 font-bold cursor-pointer">
                            Kosongkan Seed 3
                        </button>
                    </div>
                    <label class="block text-[11px] text-slate-400 mb-1.5 font-medium">Pilih Peserta untuk Seed 3:</label>
                ...
                <div x-show="activeParticipants.length >= 4" class="p-4 rounded-2xl bg-slate-950/70 border-2 transition"
                    ...
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-[11px] text-slate-400 font-bold">Bagan Atas</span>
                        </div>
                        <button type="button" x-show="selectedSeed4" @click="setSeed(4, '')" class="text-[10px] text-rose-400 hover:text-rose-300 font-bold cursor-pointer">
                            Kosongkan Seed 4
                        </button>
                    </div>
                    <label class="block text-[11px] text-slate-400 mb-1.5 font-medium">Pilih Peserta untuk Seed 4:</label>
