                    ...
                    <div class="grid grid-cols-2 gap-3 text-xs">
                        ...
                        <div class="p-3 rounded-xl bg-white border border-slate-200 space-y-2">
                            ...
                            <template x-if="selectedReg && selectedReg.document_file">
                                <a :href="'{{ url('storage') }}/' + selectedReg.document_file.replace(/^(public\/|storage\/)+/, '')" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-50 text-emerald-700 border border-emerald-200 text-xs font-bold hover:bg-emerald-100 transition">
                        ...
                        <div class="p-3 rounded-xl bg-white border border-slate-200 space-y-2">
                            ...
                            <template x-if="selectedReg && (selectedReg.payment_proof || (selectedReg.invoice && selectedReg.invoice.payment_proof))">
                                <a :href="'{{ url('storage') }}/' + (selectedReg.payment_proof || selectedReg.invoice.payment_proof).replace(/^(public\/|storage\/)+/, '')" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-50 text-amber-700 border border-amber-200 text-xs font-bold hover:bg-amber-100 transition">
                                    <i data-lucide="external-link" class="w-3.5 h-3.5"></i>
