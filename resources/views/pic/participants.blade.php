        ...
        this.$nextTick(() => {
            ...
            container.innerHTML = `
                <div class="flex flex-col items-center justify-center p-8 gap-3 text-slate-400">
                    <svg class="animate-spin w-7 h-7 text-brand-600" fill="none" viewBox="0 0 24 24">
            ...
            if (typeof pdfjsLib === 'undefined') {
                container.innerHTML = `
                    <div class="p-6 text-center space-y-3 text-slate-300 text-xs">
                        ...
                        <a href="${this.currentDocUrl}" target="_blank" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-brand-600 text-white font-bold">Buka Berkas Langsung</a>
                    </div>
                `;
                return;
            }
            ...
            loadingTask.promise.then((pdf) => {
                ...
                if (numPages > 5) {
                    ...
                    footerNote.innerHTML = `Menampilkan 5 dari ${numPages} halaman. <a href="${this.currentDocUrl}" target="_blank" class="text-brand-300 underline font-bold ml-1">Buka berkas lengkap</a>`;
